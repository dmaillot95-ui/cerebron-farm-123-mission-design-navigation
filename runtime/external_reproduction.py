...
r2=42164*u.km
o1=Orbit.circular(Earth,alt=200*u.km)
man=Maneuver.hohmann(o1,r2)
dv=sum(float(np.linalg.norm(impulse.to_value(u.m/u.s))) for _,impulse in man.impulses)
ref=3931.857009294854
err=abs(dv-ref)
ok=bool(err<5.0)
